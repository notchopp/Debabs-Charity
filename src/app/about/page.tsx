    ...
    <div className="min-h-screen p-6 md:p-12">
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <div className="space-y-4 text-lg text-white/80 leading-relaxed max-w-3xl mx-auto">
            <p>
        ...
        <motion.section
          ...
          transition={{ duration: 0.6 }}
        >
          <h2 className="text-3xl md:text-4xl font-light text-white mb-12 tracking-tight text-center">
            Our Values
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-3xl mx-auto">
            {values.map((value, index) => (
              <motion.div
                key={value.title}
                className="p-6 bg-white/10 backdrop-blur-md rounded-xl border border-white/20 hover:bg-white/15 transition-all text-center"
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
                transition={{ duration: 0.5, delay: index * 0.1 }}
              >
                <div className="w-12 h-12 bg-white/20 rounded-xl flex items-center justify-center mb-4 border border-white/20 mx-auto">
